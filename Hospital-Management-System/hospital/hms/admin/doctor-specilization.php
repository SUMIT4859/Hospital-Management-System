...
<?php include('include/sidebar.php');?>
  ...
  <div class="form-group">
    ...
    <input 
      ...
      required
    >
    <span id="error-message" style="color:red;display:none;">Please enter the doctor specialization.</span>
  </div>
...
<script>
  function validateForm() {
    var specialization = document.forms["dcotorspcl"]["doctorspecilization"].value;
