      ...
      .required::after {
        ...
        color: red;
														...
														<div class="form-group">
															<label for="DoctorSpecialization" class="required">
...
<div class="form-group">
															<label for="doctorname" class="required">
																 Doctor Name
															</label>
...
<div class="form-group">
    <label for="doccontact" class="required">Doctor Contact No</label>
    <input type="text" id="doccontact" name="doccontact" class="form-control" minlength="10" maxlength="10" required
...
<div class="form-group">
															<label for="exampleInputPassword2" class="required">
																Confirm Password
															</label>
