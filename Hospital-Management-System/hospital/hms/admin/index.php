					...
					<form class="form-login" method="post">
						...
						<p>pharmacy Login <a href="../pharmacy/index.php">pharmacylogin</a></p>
							...
							<td>
								...
								<button type="submit" class="btn btn-primary pull-right" name="submit">Doctors Login</button>
									</a>
							</td>
							
							<td>
								<a href="../user-login.php"
								<button type="submit" class="btn btn-primary pull-right" name="submit">Patients Login</button>
									</a>
							</td>
